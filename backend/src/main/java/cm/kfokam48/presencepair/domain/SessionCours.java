...
/** Une session de cours. Nommée session_cours en base pour éviter le mot réservé SESSION. */
@Entity
...
public class SessionCours {
    ...
    /** RG1, RG2 : le code n'est plus utilisable après son expiration ou après la clôture. */
